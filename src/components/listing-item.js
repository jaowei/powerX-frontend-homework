...
const Deletebutton = ({ onClick, deleteStatus }) => {
  return (
    <button
      type="button"
...
export const ListingItems = (props) => {
        ...
        <div className="mt-1 flex-1">
          <div className="flex justify-between items-center gap-3">
            ...
            <div className="text-sm text-gray-500">
              {props.numStock} piece available
            </div>
          </div>
